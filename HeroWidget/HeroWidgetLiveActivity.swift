...
struct HeroWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = HeroWidgetAttributes(name: "Me")
    static let contentState = HeroWidgetAttributes.ContentState(value: 3)
